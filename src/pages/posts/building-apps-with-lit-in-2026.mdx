...
<LinkPreview title="@quincarter/create-lit-app on npm" href="https://www.npmjs.com/package/@quincarter/create-lit-app" img="/assets/images/npm-logo.png" description="The published npm package. Run it with npx, no install required."/>
