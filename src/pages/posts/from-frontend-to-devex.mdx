...
title: 'New Role, Same Mindset: what Frontend Taught Me About Developer Experience Work'
description: I recently moved into a role leaning heavily on Docker, devcontainers, and overall Developer Experience work after spending most of my career in frontend engineering. The tools changed, but the job;  making things easier for the people who use what I build, didn't.
pubDate: 2026-08-31T12:00:00Z
imgSrc: '/assets/images/bitmoji-cat-desk.png'
imgAlt: 'Bitmoji of Quin Carter with a cat next to him on top of his laptop keyboard.'
---
